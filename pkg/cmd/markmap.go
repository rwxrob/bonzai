...
// MarkMap contains the package global default template domain specific
// language implemented as a collection of functions in
// a template.FuncMap which
...
// Cmd.MarkMap (which takes higher priority). Use Z.MarkMap when
