...
// using the rwxrob/bonzai/z/fn package with Map/Filter/Reduce/Each functions.
func (s *QS[T]) Items() []T {
	items := []T{}
...
// JSON implements rwxrob/bonzai/z/json.AsJSON.
func (s *QS[T]) JSON() ([]byte, error) { return s.MarshalJSON() }

// String implements rwxrob/bonzai/z/json.Stringer and fmt.Stringer.
...
// String implements rwxrob/bonzai/z/json.Printer.
func (s *QS[T]) Print() { fmt.Println(s.String()) }

// Log implements rwxrob/bonzai/z/json.Logger.
